        ...
        <div className="relative z-10 flex items-start justify-between gap-4">
          <div className="space-y-1.5 max-w-[82%]">
            ...
            <p className="text-xs sm:text-sm text-blue-100/90 leading-relaxed font-medium">
              Department of Orthodontics & Dentofacial Orthopedics. View performance metrics, case
              approvals, and academic progress for all active residents.
            </p>
          </div>
          <div className="bg-white/10 p-3 rounded-xl backdrop-blur-md shrink-0">
