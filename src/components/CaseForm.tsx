    ...
    <div className="case-form-shell relative">
      ...
      <header className="sticky top-0 z-30 bg-white border-b border-slate-200/90 shadow-2xs px-3.5 py-2 flex items-center justify-between gap-2 min-h-[52px] shrink-0">
        ...
        <button
          ...
          className="w-11 h-11 rounded-xl bg-slate-100 hover:bg-slate-200/80 active:bg-slate-200 text-slate-800 flex items-center justify-center transition-colors cursor-pointer shrink-0 active:scale-95"
        ...
        {/* Center: Current section title (Inter 18px Bold) */}
        <div className="flex-1 min-w-0 text-center px-1">
          <h1 className="text-[18px] font-bold text-slate-800 truncate leading-snug">
            {activeMeta.label}
          </h1>
          <p className="text-[12px] font-medium text-slate-500 truncate">
            Section {currentTabIndex + 1} of {TAB_CONFIG.length}
          </p>
        </div>
        ...
        <div className="flex items-center justify-end shrink-0 min-w-[80px]">
          {autosaveStatus === 'saving' ? (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-50 text-amber-700 text-[12px] font-medium border border-amber-200/80">
              <RefreshCw className="w-3 h-3 animate-spin text-amber-600" />
              <span>Saving...</span>
            </div>
          ) : (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[12px] font-medium border border-emerald-200/80">
