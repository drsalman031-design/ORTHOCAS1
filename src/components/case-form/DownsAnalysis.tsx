          ...
          >
            <div className="flex items-start justify-between gap-2">
              ...
              <input
                ...
                onWheel={(e) => handleInputWheel(e, meta.key, currentStage)}
                placeholder="Val"
                aria-label={`${meta.label} ${stageDisplayLabel}`}
                className={`w-[4.75rem] shrink-0 text-center py-2 px-1.5 border rounded-lg text-sm font-semibold ${validation.className}`}
              />
            </div>
