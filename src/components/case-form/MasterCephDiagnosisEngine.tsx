    ...
    <div className="w-full bg-white rounded-2xl border-2 border-indigo-200 shadow-md overflow-hidden transition-all my-4">
      ...
      {isOpen && (
        <div className="p-3.5 sm:p-5 bg-slate-50/70 space-y-4">
          ...
          {/* 12. AI DIAGNOSTIC CORRELATION */}
          <div className="p-4 rounded-xl bg-gradient-to-r from-indigo-900 to-slate-900 text-white space-y-1.5 shadow-xs">
            <div className="flex items-center gap-2 text-indigo-300">
              ...
              <span className="text-[10px] font-extrabold uppercase tracking-wider text-teal-300 block">
                AI Diagnostic Correlation (Consultant Synthesis)
              </span>
            </div>
